...
/**********************************************************
Define the thirteen functions
***********************************************************/

int scoreSum(int n, int die)
{
    int num;
        num = n * die;
    return num;
...
{
    const int n = 1;
    return scoreSum(n,ones);
}
int scoreTwos(int ones, int twos, int threes, int fours, int fives, int sixes)
{
    const int n = 2;
    return scoreSum(n,twos);
}
int scoreThrees(int ones, int twos, int threes, int fours, int fives,int sixes)
{
    const int n = 3;
    return scoreSum(n,threes);
}
int scoreFours(int ones, int twos, int threes, int fours, int fives, int sixes)
{
    const int n = 4;
    return scoreSum(n,fours);
}
int scoreFives(int ones, int twos, int threes, int fours, int fives, int sixes)
{
    const int n = 5;
    return scoreSum(n,fives);
}
int scoreSixes(int ones, int twos, int threes, int fours, int fives, int sixes)
{
    const int n = 6;
    return scoreSum(n,sixes);
}
...
{
    int score;
    score = (ones*1)+(twos*2)+(threes*3)+(fours*4)+(fives*5)+(sixes*6);
...
{
    int score = 25;
    if((ones ==5 || twos ==5 || threes ==5 || fours ==5 || fives ==5 || sixes ==5)||((ones ==3 || twos ==3 || threes ==3 || fours ==3 || fives ==3 || sixes ==3)&& (ones ==2 || twos ==2 || threes ==2 || fours ==2 || fives ==2 || sixes ==2))){
        return score;
        }
}
int scoreSmallStraight(int ones, int twos, int threes, int fours, int fives, int sixes)
